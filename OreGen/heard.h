...
namespace SymItemFullName {
	inline string getSerializedName(Item* it) {
		string itemnet = "";
		SymCall("?getSerializedName@Item@@QEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ", void, Item*, string*)(it, &itemnet);
		return itemnet;
	}
}
