...
namespace itemcheck {
	inline ItemStack* getInventoryItem(void* _this,int slot) {
		return SymCall("?getItem@FillingContainer@@UEBAAEBVItemStack@@H@Z", ItemStack*,void*, int)(*(__int64**)(*((__int64*)_this + 0x17D) + 0xB0),slot);
	}
}

namespace motd {
	inline void* setServerMotd(void* _this, string a1, bool a2) {
		return SymCall("?allowIncomingConnections@ServerNetworkHandler@@QEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@_N@Z", void*, string , bool )(a1,a2);
	}
}